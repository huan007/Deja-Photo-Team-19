...
public class DejaService extends Service {
    ...
    public class DejaThread implements Runnable {
        ...
        public void next() {
            //get next photo
            Log.d("Deja Service", "nextCalled");
            Photo nextPhoto = queue.next();

            // no photos in album
            if (nextPhoto == null) {
                Log.d("Deja Service", "No Photo");
                nextPhoto = new Photo();
                nextPhoto.photo = BitmapFactory.decodeResource(controller.currentContext.getResources(), R.drawable.apple);
            }
        ...
        public void previous() {
            //get previous photo
            Log.d("Deja Service", "previousCalled");
